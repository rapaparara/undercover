...
export function WordRevealCard() {
  ...
  return (
    <Card className="w-full max-w-md mx-auto my-auto text-center">
      <div className="space-y-6 py-2">
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center gap-2">
            <span className="text-2xl">{currentPlayer.avatarEmoji || '👤'}</span>
            <span className="text-xl font-bold text-slate-100">{currentPlayer.name}</span>
          </div>
        ...
        {!isRevealedLocally ? (
          ...
          >
            <div
              className="absolute bottom-0 left-0 top-0 bg-indigo-600/30 transition-all duration-75"
            ...
            <div className="relative z-10 space-y-3">
              ...
              <p className="text-xs text-slate-400 max-w-xs">
                Tahan ~1 detik untuk membongkar peran & kata rahasia Anda
              </p>
            </div>
          </div>
        ) : (
            ...
            {currentPlayer.role === 'mrwhite' ? (
              <div className="space-y-4 py-2">
                ...
                <div className="space-y-2">
                  ...
                  <h3 className="text-3xl font-black text-white">Anda adalah Mr. White!</h3>
                  <p className="text-sm text-slate-300 bg-slate-800/80 p-4 rounded-xl border border-slate-700 leading-relaxed">
                    Anda <span className="font-bold text-violet-400">tidak memiliki kata rahasia</span>. Dengarkan deskripsi pemain lain dengan cermat, membaurlah, dan tebak kata Warga Sipil jika Anda tereliminasi!
                  </p>
                </div>
              </div>
            ) : (
              <div className="space-y-4 py-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-400">
                    Ingat kata Anda baik-baik! Deskripsikan secara tersirat saat diskusi.
                  </p>
                </div>
              </div>
            )}
